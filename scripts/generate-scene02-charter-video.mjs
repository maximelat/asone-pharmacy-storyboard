...
const sourceUrl =
  'https://asone-pharmacy-storyboard.netlify.app/assets/gpt-image2-v2/scene-02-en-opening.png';
...
const prompt = `Premium healthcare brand animation for Servier As One scene "A 55-year story across 17 languages".
